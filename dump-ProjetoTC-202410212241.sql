...
--
-- Host: localhost    Database: ProjetoTC
-- ------------------------------------------------------
...
CREATE TABLE `carrinho` (
  ...
  CONSTRAINT `carrinho_ibfk_1` FOREIGN KEY (`cliente_id`) REFERENCES `cliente` (`id`),
...
CREATE TABLE `cliente` (
  ...
  `criado_a` timestamp NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`id`),
...
CREATE TABLE `pagamento` (
  ...
  `pagamento_date` timestamp NOT NULL DEFAULT current_timestamp(),
  `amount` decimal(10,2) NOT NULL,
  `pagamento_metodo` varchar(50) NOT NULL,
  `status` varchar(50) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `pedido_id` (`pedido_id`),
  CONSTRAINT `pagamento_ibfk_1` FOREIGN KEY (`pedido_id`) REFERENCES `pedidos` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pedidos` (
  ...
  `criado_a` timestamp NOT NULL DEFAULT current_timestamp(),
  `status` varchar(50) NOT NULL,
  `total_quantidade` decimal(10,2) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `cliente_id` (`cliente_id`),
...
CREATE TABLE `pedidos_items` (
  ...
  CONSTRAINT `pedidos_items_ibfk_1` FOREIGN KEY (`pedido_id`) REFERENCES `pedidos` (`id`),
  CONSTRAINT `pedidos_items_ibfk_2` FOREIGN KEY (`produtos_id`) REFERENCES `produtos` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping routines for database 'ProjetoTC'
--
...
-- Dump completed on 2024-10-21 22:41:34
